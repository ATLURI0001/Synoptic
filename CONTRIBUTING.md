...
Thanks for being here. Synoptic is an open foundation for live spatial intelligence in the browser, and it gets better when more people run it, break it, and extend it.
...
```bash
git clone https://github.com/ATLURI0001/synoptic.git
cd synoptic
nvm install 24.14.0
nvm use 24.14.0
npm install
...
🐛 Fix bugs / improve the first-run experience. See docs/KNOWN-ISSUES.md.
...
Pull requests
Branch off main.
Keep npm run build, npm test, and npm run test:track green and avoid new console errors.
If you change runtime behavior, update docs/CURRENT-STATE.md and CHANGELOG.md in the same PR.
If you add or change a data source, update DATA_SOURCES.md with its license and attribution. Don't add data you don't have the right to redistribute — fetch it at runtime instead.
Describe what you changed and how you verified it (screenshots welcome for anything visual).
Maintainer

Synoptic is maintained by Ram Prasad Atluri.
